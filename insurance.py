...
onehotEnc.fit(X)
df_oneHot['Vehical_type'] = pd.DataFrame(onehotEnc.transform(X).toarray())
...
onehotEnc.fit(X)
df_oneHot['Gender'] = pd.DataFrame(onehotEnc.transform(X))
...
onehotEnc.fit(X)
df_oneHot['State'] = pd.DataFrame(onehotEnc.transform(X).toarray())
